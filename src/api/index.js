...
export const api = {
  ...
  getSprintCutoff: ()              => req('/sprints/cutoff'),
  createSprintPeriod: (sprints)    => req('/sprints/period', { method: 'POST', body: JSON.stringify({ sprints }) }),
  ...
  getLeadTimeStats:  (params = {}) => req('/lead-time/stats?' + new URLSearchParams(params)),
